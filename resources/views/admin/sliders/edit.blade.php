  ...
  <section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Form Edit Slider: {{ Str::limit($slider->headline_text, 50) }}</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="headline_text" id="headline_text" 
                                   ...
                                   value="{{ old('headline_text', $slider->headline_text) }}" required
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="order_position" id="order_position" 
                                   ...
                                   value="{{ old('order_position', $slider->order_position) }}" min="0"
                                   placeholder="0">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="subheadline_text" id="subheadline_text" 
                              ...
                              rows="3"
                              placeholder="Masukkan subheadline (opsional)">{{ old('subheadline_text', $slider->subheadline_text) }}</textarea>
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="mt-2">
                                    <small class="text-muted">
                                        ...
                                        Gambar akan tetap sama jika tidak mengganti
                                    </small>
                                </div>
                            </div>
                        </div>
