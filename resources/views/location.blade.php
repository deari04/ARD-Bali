    ...
    <div class="row g-4 align-items-center">
        ...
        <div class="col-md-6">
            ...
            <h6 class="mb-4 text-secondary text-muted">
                Jl. Pulau Saelus Gg. IV No.8, Br. Pande, Kelurahan Pedungan,<br>
        ...
        <div class="col-md-6">
            <div class="contact-box">
                ...
                <ul class="list-unstyled contact-info">
                    <li><strong>Email:</strong> <a href="mailto:infoarindra@gmail.com">infoarindra@gmail.com</a></li>
                    <li><strong>Telepon:</strong> <a href="https://wa.me/6289635043530">+62 896-3504-3530</a></li>
                    <li><strong>Whatsapp:</strong> <a href="https://wa.me/6281214251202" target="_blank" rel="noopener">Chat via WhatsApp</a></li>
                </ul>
            </div>
        </div>
    </div>
